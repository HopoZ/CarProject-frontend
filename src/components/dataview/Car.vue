  ...
  <div>
    ...
    <div class="main">
            ...
            <div class="leftDef">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>{{this.data.smoke}}</td>
                </tr>
                <tr>
                  <td>
                    <center>是否喝水</center>
                  </td>
                  <td>{{this.data.water}}</td>
                </tr>
              </table>
            </div>
          </div>
        ...
        <div class="right_section">
            <!-- 温度折线图 -->
            <div class="chart_container" ref="TempchartContainer" style="width: 600px; height:250px;"></div>
            <!-- 心率折线图 -->
            <div class="chart_container" ref="HRchartContainer" style="width: 600px; height:250px;"></div>
          <!-- 温度表盘图 -->
          <div class="bottom_div">
            <div style="position: relative;z-index: 0">
...
export default {
  ...
  methods: {
    ...
    AddPhoto() {
      ...
      const imageUnkownUrl = 'http://82.156.65.122:8080/photoUnknow/';
...
.main {
  display: flex;
  width: 100vw; /* 确保容器不超过视口宽度 */
  box-sizing: border-box; /* 确保 padding 和 border 包括在元素的总宽度中 */
}
...
.positioned-span {
  position: relative;
  bottom: 140px; /* 调整距离底部的距离 */
  right: -110px; /* 调整距离右侧的距离 */
}
